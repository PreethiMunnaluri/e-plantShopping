...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (plant) => {
        const price = parsePrice(plant.cost);
        dispatch(addItem({ name: plant.name, image: plant.image, price }));
    };
                    ...
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                ...
                                <span style={{ color: 'white', fontSize: '20px', fontWeight: 800 }}>Home</span>
                            </div>
                        </a>
                    </div>
